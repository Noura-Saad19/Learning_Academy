...
<head>
    ...
    <title>Etrain</title>
    <link rel="icon"  href="{{asset('/uploads/settings/'.$set->favicon)}}">
    <!-- Bootstrap CSS -->
        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="{{route('front.homepage')}}"> <img src="{{asset('/uploads/settings/'.$set->logo)}}" alt="logo"> </a>
